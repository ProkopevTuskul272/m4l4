...
csv_file = 'Stars_Names.csv'
db_file = 'Stars_Names.db'
table_name = 'data'
columns = ['Name','Constellation','Bayern_Designation','Designation','Approval_Date']  # Замените на реальные названия столбцов из вашего CSV
